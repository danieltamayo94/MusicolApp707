...
import ItemsFormLocation from './ItemsFormLocation'
import HorizontalLogo from '../HorizontalLogo'

function RegisterFormLocation({navigation}){
  return (
         <LinearGradient colors={['#07B4F9', '#E62EB1', '#FC8353']} style={styles.linearGradient} start={{x:0, y:0}} end={{x:0, y:1}}>
                <View style={styles.containerCard}>
                    <HorizontalLogo/>
                    <ItemsFormLocation/>
                    <TouchableOpacity style={styles.buttonBack} onPress={() => navigation.navigate('RegisterFormEmail')}>
